...
print(" Read vehicle param 'MOT_PWM_MIN': %s" % vehicle.parameters['MOT_PWM_MIN'])

print(" Write vehicle param 'MOT_PWM_MIN' : 1020")
vehicle.parameters['MOT_PWM_MIN']=1020
...
print("Write vehicle param 'MOT_PWM_MIN' : 1050 (and wait for callback)")
vehicle.parameters['MOT_PWM_MIN']=1050
for x in range(1,5):
    #Callbacks may not be updated for a few seconds
    if vehicle.parameters['MOT_PWM_MIN']==1050:
        break
    time.sleep(1)
...
print(" Change MOT_PWM_MIN parameters (and wait for callback)")    
#vehicle.parameters['THR_MID']=400  
vehicle.parameters['MOT_PWM_MIN']=1070
